...
export function getStoryFactory<Props extends Record<string, any>>(params: {
    ...
    function getStory(props: Props, params?: { defaultContainerWidth?: number; description?: string }): typeof Template {
        ...
        "meta": id<Meta>({
            ...
            "parameters": {
                "docs": {
                    "description": {
                        "component": [
                            ...(doHideImportInstruction ? [] : [`\`import { ${componentName} } from "@codegouvfr/react-dsfr/${componentName}"\``]),
